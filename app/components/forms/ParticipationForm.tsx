...
export function ParticipationForm({kind}:{kind:Kind}){
  ...
  return <form className="support-form" action="https://formsubmit.co/karinnalozz20@gmail.com" method="POST" onSubmit={submit}>
    ...
    <label className="consent"><input type="checkbox" name="Autorización de tratamiento" value="Autorizada" required/><span>Autorizo el tratamiento de mis datos para estudiar y responder esta solicitud conforme a la <a href="/#privacidad">política de privacidad</a>.</span></label>
