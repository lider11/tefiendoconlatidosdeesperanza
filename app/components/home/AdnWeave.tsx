...
export function AdnWeave(){
  ...
  return <section className="adn-weave" id="adn"><div className="section">
    ...
    <div className="weave-join"><div><span>Somos muchos hilos, un mismo propósito</span><p>Cada persona puede aportar una capacidad distinta. Cuando las entrelazamos, construimos comunidades más fuertes, justas e inclusivas.</p></div><div><a className="button" href="#participa">Quiero ser parte</a><Link className="button button-ghost" href="/programas">Conocer nuestros programas</Link></div></div>
  </div></section>
}
