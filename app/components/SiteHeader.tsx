  ...
  return <>
    ...
    <header className="site-header">
      ...
      <nav id="main-navigation" className={open?"open":""} aria-label="Navegación principal">
        <Link href="/#nosotros" onClick={close}>Quiénes somos</Link><Link href="/programas" onClick={close}>Programas</Link><Link href="/#impacto" onClick={close}>Impacto</Link><Link href="/#transparencia" onClick={close}>Transparencia</Link><Link href="/voluntariado" onClick={close}>Voluntariado</Link><Link href="/alianzas" onClick={close}>Alianzas</Link><Link href="/solicitar-orientacion" onClick={close}>Solicitar orientación</Link>
      </nav>
